...
const SelectProgram = () => {
    ...
    //현재 선택한 프로그램의 정보 저장
    const { setProgramInfo } = useProgramStore();
    const CardStyle = css`
    color: white;
    ...
    const goDetailRoutine = () => {
        setProgramInfo(searchResult[selectedResult]);
                        ...
                        <TabPanel>
                            ...
                            {selectedResult !== -1 &&
                                <>
                                    ...
                                    {/* 세부사항 요약창 작성 */}
                                    <RoutineShort isDetail={true} result={searchResult[selectedResult]} />
                                    ...
                                    <Flex alignSelf="center" justifyContent={"space-between"}>
                                        ...
                                        <Button onClick={goDetailRoutine} bg={ThemeColor.backgroundColor} flexGrow={1} _hover={{ backgroundColor: ThemeColor.backgroundColorDarker }}>자세히 보기</Button>
                                    </Flex>
